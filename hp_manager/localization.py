...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "money.window_title": "Party Money",
        ...
        "status.money_saved": "Party money updated.",
    ...
    "ru": {
        ...
        "player.window_title": "{name} HP",
        "money.window_title": "Деньги группы",
        ...
        "status.money_saved": "Деньги группы обновлены.",
