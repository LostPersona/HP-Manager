...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "status.sync_applied_skipped": "Applied {applied} line(s) from sync preview and skipped {skipped} unknown name(s).",
        "status.sync_applied_with_issues": "Applied {applied} line(s), with {issues} parse issue(s).",
        "status.sync_applied_with_issues_skipped": "Applied {applied} line(s), skipped {skipped} unknown name(s), with {issues} parse issue(s).",
        ...
        "status.doc_fetched_skipped": "Fetched Google Doc, applied {applied} line(s), and skipped {skipped} unknown name(s).",
    ...
    "ru": {
        ...
        "status.sync_applied_skipped": "Применено строк из предпросмотра: {applied}, пропущено неизвестных имен: {skipped}.",
        "status.sync_applied_with_issues": "Применено строк: {applied}, проблем парсинга: {issues}.",
        "status.sync_applied_with_issues_skipped": "Применено строк: {applied}, пропущено неизвестных имен: {skipped}, проблем парсинга: {issues}.",
        ...
        "status.doc_fetched_skipped": "Google Doc загружен, применено строк: {applied}, пропущено неизвестных имен: {skipped}.",
